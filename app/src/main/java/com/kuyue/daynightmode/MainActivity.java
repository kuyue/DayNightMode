...
public class MainActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener{
    ...
    private CheckBox mCheckBoxBook, mCheckBoxZhi;
    ...
    private void initEvent() {
        mCheckBoxBook.setOnCheckedChangeListener(this);
        mCheckBoxZhi.setOnCheckedChangeListener(this);
    }

    private void initView() {
        mCheckBoxList = new ArrayList<>();
        mCheckBoxBook = (CheckBox) findViewById(R.id.cb_book);
        mCheckBoxZhi = (CheckBox) findViewById(R.id.cb_zhi);
        mCheckBoxList.add(mCheckBoxBook);
        mCheckBoxList.add(mCheckBoxZhi);
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
        ...
        if (viewId == R.id.cb_book) {
            changeThemeByJianShu();

        } else if (viewId == R.id.cb_zhi) {
            changeThemeByZhiHu();
    ...
    private void refreshUI() {
        ...
        for (int childIndex = 0; childIndex < childCount; childIndex++) {
            ...
            View infoLayout = childView.findViewById(R.id.ll);
            infoLayout.setBackgroundResource(background.resourceId);
            TextView nickName = (TextView) childView.findViewById(R.id.tv);
